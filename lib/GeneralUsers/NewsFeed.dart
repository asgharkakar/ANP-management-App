...
class GeneralUserNewsFeeds extends StatefulWidget {
  @override
  _GeneralUserNewsFeedsState createState() => _GeneralUserNewsFeedsState();
}

class _GeneralUserNewsFeedsState extends State<GeneralUserNewsFeeds> {
                        ...
                        Row(
                          ...
                          children: [
                            TextButton.icon(
                              ...
                              label: Text("Like ${likedBy.length}"),
