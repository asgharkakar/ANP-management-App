...
class AddProvinceActivities extends StatefulWidget {
  const AddProvinceActivities({super.key});

  @override
  State<AddProvinceActivities> createState() => _AddProvinceActivitiesState();
}

class _AddProvinceActivitiesState extends State<AddProvinceActivities> {
  ...
  Future<void> saveActivity() async {
    ...
    await _firestore.collection("ProvinceCollection")
        .doc(provinceName)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Add Province Activities", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
      body: Padding(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Province: ${provinceName ?? "Loading..."}",
