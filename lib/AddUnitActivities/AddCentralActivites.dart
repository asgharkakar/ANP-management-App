...
class AddCentralActivities extends StatefulWidget {
  const AddCentralActivities({super.key});

  @override
  State<AddCentralActivities> createState() => _AddCentralActivitiesState();
}

class _AddCentralActivitiesState extends State<AddCentralActivities> {
  ...
  Future<void> fetchCentralPresidentName() async {
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        setState(() {
          centralPresidentName = querySnapshot.docs.first['name'];
        });
      }
    } catch (e) {
  ...
  Future<void> saveActivity() async {
    if (centralPresidentName == null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Central President not found")));
      return;
    }

    await _firestore.collection("CentralCollection")
        .doc(centralPresidentName)
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text("Activity Saved Successfully")));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Add Central Activities", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ),
      body: Padding(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text("Central President: ${centralPresidentName ?? "Loading..."}",
